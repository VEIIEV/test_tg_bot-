...
// указываем, что это конфигураци€, котора€ опираетс€ на такой-то пакет и такой-то config-файл, плюс позвол€ет управл€ть транзакци€ми
@Configuration
...
public class MyJpaConfig {
    ...
    // сервис текущего окружени€ (с параметрами и т.д.)
    @Autowired
